...
class WithdrawMethodController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.withdraw.create', compact('pageTitle', 'currencies', 'pageName','buttonText','method'));
    }
    ...
    public function edit($id)
    {
        ...
        $buttonText =  "Update";
        $currencies = Currency::where('status', 1)->get();
        return view('admin.withdraw.edit', compact('pageTitle', 'method', 'currencies','buttonText'));
    }
