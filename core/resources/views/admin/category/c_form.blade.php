...
<div class="custom-card kyc-form">
    <div class="card-header">
        <h6 class="title">KYC Data Form</h6>
        <button class="btn--base add-row-btn"><i class="fas fa-plus"></i> Add</button>
    </div>
    <div class="card-body">
        <form class="card-form">
            ...
            <div class="row add-row-wrapper align-items-end">
                ...
                <div class="col-xl-2 col-lg-2 form-group">
                    ...
                    </select><div class="nice-select form--control" tabindex="0"><span class="current">Select Field Type</span><ul class="list"><li data-value="" class="option selected">Select Field Type</li><li data-value="1" class="option">Input Text</li><li data-value="2" class="option">Textarea</li><li data-value="3" class="option">File</li></ul></div>
                </div>
                <div class="col-xl-2 col-lg-2 form-group">
                    <label>Min Character*</label>
                    <input type="number" class="form--control" placeholder="ex: 6">
                </div>
                <div class="col-xl-2 col-lg-2 form-group">
                    <label>Max Character*</label>
                    <input type="number" class="form--control" placeholder="ex: 16">
                </div>
                <div class="col-xl-2 col-lg-2 form-group">
                    <label>Field Necessity*</label>
                    <div class="toggle-container">
                        <div class="switch-toggles active">
                            <input type="hidden" name="switch" value="required">
                            <label class="switch" data-value="required">Required</label>
                            <label class="switch" data-value="optional">Optional</label>
                        </div>
                    </div>
                </div>
                <div class="col-xl-1 col-lg-1 form-group">
                    <button type="button" class="custom-btn btn--base btn--danger kyc-cross-btn w-100"><i class="las la-times"></i></button>
                </div>
            </div>
            <div class="row add-row-wrapper align-items-end">
                <div class="col-xl-3 col-lg-3 form-group">
                ...
                <div class="col-xl-2 col-lg-2 form-group">
                    ...
                    </select><div class="nice-select form--control" tabindex="0"><span class="current">File</span><ul class="list"><li data-value="1" class="option selected">File</li><li data-value="2" class="option">Input Text</li><li data-value="3" class="option">Textarea</li></ul></div>
                </div>
                <div class="col-xl-2 col-lg-2 form-group">
                ...
                <div class="col-xl-2 col-lg-2 form-group">
                    ...
                    </select><div class="nice-select form--control" tabindex="0"><span class="current">Select Extension</span><ul class="list"><li data-value="" class="option selected">Select Extension</li><li data-value="1" class="option">jpg</li><li data-value="2" class="option">png</li><li data-value="3" class="option">pdf</li></ul></div>
                </div>
                <div class="col-xl-2 col-lg-2 form-group">
                    <label>Field Necessity*</label>
                    <div class="toggle-container">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 form-group">
                    <button type="submit" class="btn--base w-100">Save &amp; Change</button>
                </div>
            </div>
        </form>
    </div>
