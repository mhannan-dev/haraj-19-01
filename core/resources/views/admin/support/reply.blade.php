                ...
                <div class="support-chat-area">
                    <div class="card-body ">
                                ...
                                <div class="col-sm-4  col-md-6 text-sm-right mt-sm-0 mt-3">
                                    @if ($ticket->status != 3)
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <button data-bs-target="#DelModal"
                                                class="btn btn--danger btn-sm rounded text-white" data-bs-toggle="modal"
                                                type="button">
                                                <i class="fa fa-lg fa-times-circle"></i> @lang('Close Ticket')</button>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        </h6>
                        <form action="{{ route('admin.tickets.reply', $ticket->id) }}" enctype="multipart/form-data"
                            method="post" class="form-horizontal">
                            @csrf
                            <div class="row ">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control form--control" name="message" rows="8" id="inputMessage"
                                ...
                                <div class="col-md-6">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-3">
                                            <button type="button"
                                                class="btn btn--primary text-white extraTicketAttachment"><i
                                ...
                                <div class="col-md-3 offset-md-3">
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button class="btn btn--primary btn-block mt-4 rounded text-white" type="submit"
                        ...
                        @foreach ($messages as $message)
                                ...
                                <div class="row border border-primary border-radius-3 my-3 mx-2">
                                    ...
                                    <div class="col-md-3 border-right text-right">
                                        ...
                                        <button data-id="{{ $message->id }}" type="button" data-bs-toggle="modal"
                                            data-bs-target="#DelMessage" class="btn btn-danger btn-sm my-3 delete-message"><i
                            ...
                            @else
                                <div class="row border border-success border-radius-3 my-3 mx-2 admin-bg-reply">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        @if ($message->attachments()->count() > 0)
                                            <div class="my-3">
                                                @foreach ($message->attachments as $k => $image)
                                                    <a href="{{ route('admin.tickets.download', encrypt($image->id)) }}"
                                                        class="mr-3"><i class="fa fa-file"></i> @lang('Attachment')
                                                        {{ ++$k }} </a>
                                                @endforeach
                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="post" action="{{ route('admin.tickets.reply', $ticket->id) }}">
                            ...
                            <button type="submit" class="btn btn--success rounded" name="replayTicket" value="2">
                                @lang('Close Ticket') </button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="DelMessage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="post" action="{{ route('admin.tickets.delete') }}">
                            @csrf
                            <input type="hidden" name="message_id" class="message_id">
                            <button type="button" class="btn btn--primary rounded"
                            data-bs-dismiss="modal">@lang('No')
                            </button>
                            <button type="submit" class="btn btn--danger rounded"><i class="fa fa-trash"></i>
                                @lang('Delete')
                            </button>
                        </form>
                    </div>
