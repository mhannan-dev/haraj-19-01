            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Amount')
                            <span class="font-weight-bold">{{ showAmount($withdrawal->amount,$withdrawal->curr) }} {{ __($withdrawal->curr->currency_code) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Charge')
                            <span class="font-weight-bold">{{ showAmount($withdrawal->charge,$withdrawal->curr) }} {{ __($withdrawal->curr->currency_code) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('After Charge')
                            <span class="font-weight-bold">{{ showAmount($withdrawal->after_charge,$withdrawal->curr) }} {{ __($withdrawal->curr->currency_code) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Payable')
                            <span class="font-weight-bold">{{ showAmount($withdrawal->final_amount,$withdrawal->curr) }} {{__($withdrawal->curr->currency_code)}}</span>
                        </li>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button class="btn btn--success ml-1 approveBtn" data-toggle="tooltip" data-original-title="@lang('Approve')"
                                        data-id="{{ $withdrawal->id }}" data-amount="{{ showAmount($withdrawal->final_amount,$withdrawal->curr) }} {{$withdrawal->curr->currency_code}}">
                                ...
                                <button class="btn btn--danger ml-1 rejectBtn" data-toggle="tooltip" data-original-title="@lang('Reject')"
                                        data-id="{{ $withdrawal->id }}" data-amount="{{ showAmount($withdrawal->final_amount,$withdrawal->curr) }} {{__($withdrawal->curr->currency_code)}}">
