        ...
        <div class="row match-height">
            <div class="col-md-12">
                <div class="card">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                @csrf
                                                <div class="form-body">
                                                    {!! Form::text('search_string', null, [
                                                        'class' => 'form-control mb-1',
                                                        'data-validation-required-message' => __('form.field_required'),
                                                        'placeholder' => __('assign_access.assign_access_search_field_placeholder'),
                                                        'tabindex' => 1,
                                                    ]) !!}
                                                </div>
                    ...
                    @if ($userName)
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form-center">@lang('Showing') @lang('Result')
                                @lang('For') <i>{{ $userName }}</i></h4>
                        </div>
                    @endif
                                        ...
                                        <tbody>
                                            @foreach ($triggers as $row)
                                                <tr>
                                                    ...
                                                    <td>{{ $row->first_name }} {{ $row->middle_name }} {{ $row->last_name }}
                                                    </td>
                                                    <td>{{ $row->username }}</td>
                                                    ...
                                                    <td>
                                                        @if (hasAccessAbility('edit_admin_user', $roles))
                                                            <a href="#"
                                                                class="btn btn-social btn-min-width mb-1 mr-1 btn-outline-vimeo"><span
                                                                    class="la la-anchor font-medium-4"></span>
                                                                @lang('assign_access.assign_access_btn')</a>
                                                        @endif
