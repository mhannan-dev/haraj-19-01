                ...
                <div class="row">
                    <div class="col-lg-12 mb-30">
                        <div class="user-info-header two">
                            ...
                            <div class="info-btn">
                                <a data-bs-target="#testSMSModal" data-bs-toggle="modal">Send Test SMS <i class="las la-paper-plane"></i></a>
                            </div>
                        </div>
                        <div class="dashboard-form-area two mt-10">
                            <form class="dashboard-form" action="{{ route('admin.sms.templates.setting') }}" method="POST">
                                @csrf
    ...
    <div id="testSMSModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.sms.templates.send.test.sms') }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn--base bg--danger" data-bs-dismiss="modal">@lang('Close')</button>
