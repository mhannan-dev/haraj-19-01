                ...
                <div class="row">
                    <div class="col-lg-12 mb-30">
                        <div class="user-info-header two">
                            <h5 class="title">SMS Setting</h5>
                            <div class="info-btn">
                                <a data-bs-target="#testSMSModal" data-bs-toggle="modal">Send Test SMS <i
                                        class="las la-paper-plane"></i></a>
                            </div>
                        </div>
                        <div class="dashboard-form-area two mt-10">
                            <form class="dashboard-form" action="{{ route('admin.sms.template.setting') }}" method="POST">
                                @csrf
                                <div class="row justify-content-center mb-10-none">
                                    ...
                                    <div class="form-row mt-4 d-none configForm" id="clickatell">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label class="font-weight-bold">@lang('Api Key') <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="@lang('Api Key')"
                                                name="clickatell_api_key"
                                                value="{{ @$general->sms_config->clickatell_api_key }}" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="@lang('Username')"
                                                    ...
                                                    value="{{ @$general->sms_config->infobip_username }}" />
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="@lang('Password')"
                                                    ...
                                                    value="{{ @$general->sms_config->infobip_password }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row mt-4 d-none configForm" id="messageBird">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('Api Key')"
                                                ...
                                                value="{{ @$general->sms_config->message_bird_api_key }}" />
                                        </div>
                                    </div>
                                    <div class="form-row mt-4 d-none configForm" id="nexmo">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="font-weight-bold">@lang('Api Secret') <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="@lang('Username')" name="sms_broadcast_username"
                                                    value="{{ @$general->sms_config->sms_broadcast_username }}" />
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="font-weight-bold">@lang('Password') <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    placeholder="@lang('Password')" name="sms_broadcast_password"
                                                    value="{{ @$general->sms_config->sms_broadcast_password }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row mt-4 d-none configForm" id="twilio">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="font-weight-bold">@lang('Account SID') <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    placeholder="@lang('Account SID')" name="account_sid"
                                                    value="{{ @$general->sms_config->account_sid }}" />
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="font-weight-bold">@lang('Auth Token') <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    placeholder="@lang('Auth Token')" name="auth_token"
                                                    value="{{ @$general->sms_config->auth_token }}" />
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="font-weight-bold">@lang('From Number') <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    placeholder="@lang('From Number')" name="from"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label class="font-weight-bold">@lang('Username') <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    placeholder="@lang('Username')" name="text_magic_username"
                                                    value="{{ @$general->sms_config->text_magic_username }}" />
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="font-weight-bold">@lang('Apiv2 Key') <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control"
                                                    placeholder="@lang('Apiv2 Key')" name="apiv2_key"
                                                    value="{{ @$general->sms_config->apiv2_key }}" />
                                            </div>
                                        </div>
                                    </div>
