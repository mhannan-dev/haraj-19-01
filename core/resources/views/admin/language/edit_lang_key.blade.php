...
@section('content')
    <div class="dashboard-title-part">
        ...
        <div class="view-prodact">
            ...
            <a href="#" data-bs-toggle="modal" data-bs-target="#addModal"><i class="la la-plus"></i> @lang('Add New Key')
            </a>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="table-wrapper table-responsive">
                <table class="custom-table small tabstyle--two custom-data-table white-space-wrap" id="myTable">
                    <thead>
                        <tr>
                            <th>@lang('Key')
                            </th>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <button data-bs-target="#editModal" data-bs-toggle="modal"
                                        ...
                                        data-value="{{ $language }}" class="editModal btn--warning m-1"
                                        title="@lang('Edit')">
