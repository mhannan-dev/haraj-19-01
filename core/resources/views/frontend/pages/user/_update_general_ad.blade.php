                                            ...
                                            @foreach ($category->type->fields as $field)
                                                <div class="form-group">
                                                    ...
                                                    @elseif ($field->type == 'number')
                                                        <input type="{{ $field->type }}" name="{{ $field->label }}"
                                                            class="form--control"
                                                            required="{{ $field->validation->required }}" value="{{ $adv->price }}">
                                                        <input type="hidden" name="editable"
                                                            value="{{ $field->editable }}">
                                                        ...
                                                        <select name="{{ $field->label }}" class="form--control">
                                                            ...
                                                            @foreach ($brands as $brand)
                                                                <option value="{{ $brand->id }}"
                                                                    @if ($adv->brand_id == $brand->id) selected @else '' @endif>
                                                                    {{ $brand->title }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    @elseif ($field->type == 'select')
                                                        ...
                                                        <select name="{{ $field->label }}" class="form--control">
                                                            ...
                                                            @foreach ($field->validation->options as $op)
                                                                <option value="{{ $op }}"
                                                                    @if ($adv->condition == $op) selected @else '' @endif>
                                                                    {{ ucfirst($op) }} </option>
                                                            @endforeach
                                                        </select>
                                                        <input type="hidden" name="editable"
                                                    ...
                                                    @elseif ($field->type == 'textarea')
                                                        <textarea name="{{ $field->label }}" class="form--control">{{ $adv->description }}</textarea>
                                                    @endif
                                                </div>
                                                <div class="form-group">

                                                        @foreach ($details_informations->validation->options as $data_checkbox)
                                                        {{-- @dd($data_checkbox) --}}
